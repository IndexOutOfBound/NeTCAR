...
function loadLiquidFillGauge(elementId, value, config) {
    ...
    var textRiseScaleY = d3.scale.linear()
        .range([fillCircleMargin+fillCircleRadius*2,(fillCircleMargin+textPixels*0.5)])
        .domain([0,1]);
    ...
    var text22 = gaugeGroup.append("text")
        .text(config.cityText)
        .attr("class", "liquidFillGaugeText")
        .attr("text-anchor", "middle")
        .attr("font-size", textPixels*0.8 + "px")
        .style("fill", config.textColor)
        .attr('transform','translate('+radius+','+textRiseScaleY(config.cityVertPosition)+')');
